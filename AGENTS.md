...
5. Test physical buttons against the user's current Codex version. The Cmd+Shift+Return steering gesture is a candidate, not a verified guarantee. If it fails, report the observed result and update the preset only with evidence.
